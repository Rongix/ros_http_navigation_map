 ...
 * @author Paweł Franitza //FIXES  //Please note, you should change server and action name topics
...
NAV2D.Navigator = function (options) {
  ...
  function sendGoal(pose) {
    ...
    var goalMarker = new ROS2D.NavigationArrow({
      size: 12,
      strokeSize: 1,
      fillColor: createjs.Graphics.getRGB(242, 48, 0, 0.7),
      pulse: false
    });
  ...
  var robotMarker = new ROS2D.NavigationArrow({
    ...
    fillColor: createjs.Graphics.getRGB(0, 155, 217, 0.9),
    pulse: true
  });
  ...
  poseListener.subscribe(function (odom) {
